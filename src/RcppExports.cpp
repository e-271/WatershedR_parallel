...
// update_marginal_probabilities_exact_inference_parallel_cpp
...
RcppExport SEXP _WatershedR_update_marginal_probabilities_exact_inference_parallel_cpp(SEXP featSEXP, SEXP discrete_outliersSEXP, SEXP theta_singletonSEXP, SEXP theta_pairSEXP, SEXP thetaSEXP, SEXP phi_inlierSEXP, SEXP phi_outlierSEXP, SEXP number_of_dimensionsSEXP, SEXP number_of_pairsSEXP, SEXP posterior_boolSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericMatrix >::type feat(featSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type number_of_pairs(number_of_pairsSEXP);
    Rcpp::traits::input_parameter< bool >::type posterior_bool(posterior_boolSEXP);
    rcpp_result_gen = Rcpp::wrap(update_marginal_probabilities_exact_inference_parallel_cpp(feat, discrete_outliers, theta_singleton, theta_pair, theta, phi_inlier, phi_outlier, number_of_dimensions, number_of_pairs, posterior_bool));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_WatershedR_update_marginal_probabilities_exact_inference_parallel_cpp", (DL_FUNC) &_WatershedR_update_marginal_probabilities_exact_inference_parallel_cpp, 10},
    {"_WatershedR_compute_crf_likelihood_exact_inference_parallel_cpp", (DL_FUNC) &_WatershedR_compute_crf_likelihood_exact_inference_parallel_cpp, 13},
