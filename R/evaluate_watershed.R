...
#'   length \code{number_of_dimensions} giving a separate L2 prior for each dimension of 
#'   the input omes (analogous to passing a vector for \code{dirichlet_prior}). 
#'   If set to NULL, Watershed will run a grid search on held-out data to select a single 
#'   optimal L2 prior shared across dimensions. We recommend setting this parameter to NULL. 
#'   Default: NULL
